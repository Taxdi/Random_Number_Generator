# generators/mt19937.py
"""
Mersenne Twister MT19937
PRNG de période 2^19937 -1
...
def twist(state):
    for i in range(N):
        ...
        bit_haut = state[i] & 0x80000000  # 1 bit MSB
        bits_bas = state[(i + 1) % N] & 0x7FFFFFFF  # 31 bits LSB
        x = bit_haut | bits_bas
        
        # Shift et conditionnelle
        x_shifted = x >> 1
        if x % 2 == 1:  # Bit de poids faible = 1
            x_shifted ^= A
